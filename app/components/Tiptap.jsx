        ...
        <div className='h-full'>
            <div className='my-3 mx-1 p-1 grid grid-rows-2 grid-cols-10 outline-2 outline-slate-500 rounded-md gap-y-2'>
                ...
                <button
                    ...
                    className={editor.isActive('highlight', { color: '#ffc078' }) ? 'bg-gray-100' : ''}
                >
                    Orange
                </button>
                <button
                    onClick={() => editor.chain().focus().toggleHighlight({ color: '#8ce99a' }).run()}
                    className={editor.isActive('highlight', { color: '#8ce99a' }) ? 'bg-gray-100' : ''}
                >
                    Green
                </button>
                <button
                    onClick={() => editor.chain().focus().toggleHighlight({ color: '#74c0fc' }).run()}
                    className={editor.isActive('highlight', { color: '#74c0fc' }) ? 'bg-gray-100' : ''}
                >
                    Blue
                </button>
                <button
                    onClick={() => editor.chain().focus().toggleHighlight({ color: '#b197fc' }).run()}
                    className={editor.isActive('highlight', { color: '#b197fc' }) ? 'bg-gray-100' : ''}
                >
                    Purple
                </button>
                <button
                    onClick={() => editor.chain().focus().toggleHighlight({ color: 'red' }).run()}
                    className={editor.isActive('highlight', { color: 'red' }) ? 'bg-gray-100' : ''}
                >
                    Red ('red')
                </button>
                <button
                    onClick={() => editor.chain().focus().toggleHighlight({ color: '#ffa8a8' }).run()}
                    className={editor.isActive('highlight', { color: '#ffa8a8' }) ? 'bg-gray-100' : ''}
                >
                    Red (#ffa8a8)
                </button> */}
                {/* Link */}
                ...
                <button
                    ...
                    className={editor.isActive('heading', { level: 2 }) ? 'bg-gray-100' : "rte_toolbar_btn"}
                >
                    H2
                </button> 
                <button
                    onClick={() => editor.chain().focus().toggleHeading({ level: 3 }).run()}
                    className={editor.isActive('heading', { level: 3 }) ? 'bg-gray-100' : "rte_toolbar_btn"}
                >
                    H3
                </button>
                {/* HardBreak */}
